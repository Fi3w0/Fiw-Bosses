...
public class ArcSlashGoal extends Goal {
    ...
    public void tick() {
        ...
        for (int pi = iStart; pi <= iEnd; pi++) {
            ...
            if (pi == points / 2) {
                level.sendParticles(ColorParticleOption.create(ParticleTypes.FLASH, 0xFFFFFFFF), pos.x, pos.y, pos.z, 1, 0, 0, 0, 0);
            }
        ...
        if (slashTick == duration) {
            ...
            level.sendParticles(ColorParticleOption.create(ParticleTypes.FLASH, 0xFFFFFFFF), endPos.x, endPos.y, endPos.z, 1, 0, 0, 0, 0);
            level.sendParticles(ParticleTypes.CRIT,
