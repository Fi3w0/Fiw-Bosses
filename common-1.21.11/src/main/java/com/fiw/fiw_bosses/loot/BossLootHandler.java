...
public final class BossLootHandler {
    ...
    public static void dropLootEntries(LivingEntity entity, List<LootEntry> lootEntries) {
        ...
        for (LootEntry entry : lootEntries) {
            ...
            ItemStack stack = ConfiguredItemStacks.loot(entry, count, entity.level().getServer(), entity.registryAccess());
            ...
            while (remaining > 0) {
                ...
                entity.spawnAtLocation((ServerLevel) entity.level(), stack.copyWithCount(size));
                remaining -= size;
            }
        }
    }
