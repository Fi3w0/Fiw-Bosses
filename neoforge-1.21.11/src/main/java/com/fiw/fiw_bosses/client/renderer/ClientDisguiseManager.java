...
import com.fiw.fiw_bosses.network.BossRenderPayload;
...
public final class ClientDisguiseManager {
    ...
    public static void handlePayload(BossRenderPayload payload, IPayloadContext context) {
        context.enqueueWork(() -> registerDisguise(payload.entityId(), payload.disguiseEntity()));
    }
