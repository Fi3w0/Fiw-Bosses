...
public class FiwBossesForge {

    public FiwBossesForge() {
        FiwBossesCore.LOGGER.info("FIW Bosses (Forge 1.20.1) initializing...");
        ...
        FiwBossesCore.LOGGER.info("FIW Bosses (Forge 1.20.1) initialized.");
    }
