...
Fabric builds require **[Fabric API](https://modrinth.com/mod/fabric-api)**. **[Fiw Tools](https://modrinth.com/mod/fiw-tools)** is optional — when present, equipment and loot can reference its items by `toolId`; when absent, those entries are simply skipped.
