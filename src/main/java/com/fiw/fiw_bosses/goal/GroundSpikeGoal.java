...
public class GroundSpikeGoal extends Goal {
    ...
    public void tick() {
        ...
        if (phase == 0) {
            ...
            DustParticleOptions dustRed = new DustParticleOptions(new Vector3f(0.8f, 0.2f, 0.1f), 1.0f);
            ...
            if (tick == markTicks - 5) {
                level.playSound(null, boss.getX(), boss.getY(), boss.getZ(),
                        SoundEvents.GENERIC_EXPLODE.value(), SoundSource.HOSTILE, 1.2f, 0.4f);
            }
            ...
            if (tick == markTicks) {
                ...
                level.playSound(null, boss.getX(), boss.getY(), boss.getZ(),
                        SoundEvents.GENERIC_EXPLODE.value(), SoundSource.HOSTILE, 1.8f, 0.7f);
            }
