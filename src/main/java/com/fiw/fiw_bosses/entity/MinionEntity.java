...
public class MinionEntity extends BossEntity {
    ...
    public void addAdditionalSaveData(CompoundTag nbt) {
        // Call Monster's save (skips BossEntity's BossId/phase save — we don't need it).
        // We intentionally omit "BossId" so BossEntity.readAdditionalSaveData is a no-op.
        // Monster.addAdditionalSaveData is what persists mob base data (health, pos, etc.).
        super.addAdditionalSaveData(nbt);
        // Remove the BossId that BossEntity wrote — minions don't use it.
        nbt.remove("BossId");
    ...
    public void readAdditionalSaveData(CompoundTag nbt) {
        // BossEntity.readAdditionalSaveData checks for "BossId" first — since
        // we removed it in save, it will call Monster's read then return early.
