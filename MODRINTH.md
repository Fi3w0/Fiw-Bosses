...
**Optional:** [Fiw Tools](https://modrinth.com/mod/fiw-tools) — when present, equipment and loot can reference its items by `toolId`; when absent, those entries are skipped and nothing breaks.
